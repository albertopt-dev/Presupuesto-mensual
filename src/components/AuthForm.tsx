  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900">
      ...
      <form
        ...
        className="relative z-10 w-full max-w-sm mx-4 px-8 py-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl animate-auth-enter"
      >
        {/* Título */}
      ...
      <style jsx>{`
        ...
        .animate-auth-enter {
          animation: authEnter 0.5s ease-out both;
        }
      `}</style>
    </div>
  );
